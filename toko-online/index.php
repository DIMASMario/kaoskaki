    ...
    <div class="navbar-box">
      <ul class="navbar-list">
        ...
        <?php if (!isset($_SESSION['login'])) { ?>
          <li><a href="./auth/login"><i class="fas fa-lock"></i> login</a></li>
        <?php } else { ?>
    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>sokincek</h2>
          <p>
            Sokincek adalah UMKM kaos kaki yang berdedikasi menghadirkan kenyamanan dan gaya untuk setiap langkah Anda. 
            Kami menyediakan beragam pilihan kaos kaki berkualitas tinggi, cocok untuk berbagai aktivitas dan gaya hidup
          </p>
        ...
        <div class="col-md-6 my-auto mx-auto" data-aos="zoom-in">
          <div class="d-flex justify-content-center align-items-center flex-column">
            <img src="assets/img/sokincek.jpg" alt="banner" class="my-5">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="footer bg-dark" id="contact">
    <div class="footer-content">
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          <h4 class="text-light text-poppins font-weight-bold">sokincek</h4>
      ...
      <div class="row">
        <div class="col">
          <div class="d-flex justify-content-center align-items-center text-center flex-column mx-auto">
            <span class="d-block text-light">sokincek© Copyright <strong>2025</strong>. All Right Reserved</span>
          </div>
        </div>
      </div>
    </div>
